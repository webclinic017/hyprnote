...
import { type Options, getHealth, getApiDesktopUserIntegrations, getApiDesktopSubscription, postApiWebConnect, getApiWebSessionById, postApiWebIntegrationConnection, postChatCompletions } from '../sdk.gen';
import { queryOptions, type UseMutationOptions, type DefaultError } from '@tanstack/react-query';
import type { GetHealthData, GetApiDesktopUserIntegrationsData, GetApiDesktopSubscriptionData, PostApiWebConnectData, PostApiWebConnectResponse, GetApiWebSessionByIdData, PostApiWebIntegrationConnectionData, PostApiWebIntegrationConnectionResponse, PostChatCompletionsData } from '../types.gen';
...
export const getApiDesktopSubscriptionQueryKey = (options?: Options<GetApiDesktopSubscriptionData>) => createQueryKey('getApiDesktopSubscription', options);

export const getApiDesktopSubscriptionOptions = (options?: Options<GetApiDesktopSubscriptionData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiDesktopSubscription({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiDesktopSubscriptionQueryKey(options)
    });
};
