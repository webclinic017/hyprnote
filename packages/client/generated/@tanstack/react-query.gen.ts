...
import { type Options, getHealth, postApiNativeChatCompletions, getApiNativeUserIntegrations, getApiNativeSubscription, postApiWebConnect, getApiWebSessionById, postApiWebIntegrationConnection } from '../sdk.gen';
import { queryOptions, type UseMutationOptions, type DefaultError } from '@tanstack/react-query';
import type { GetHealthData, PostApiNativeChatCompletionsData, GetApiNativeUserIntegrationsData, GetApiNativeSubscriptionData, PostApiWebConnectData, PostApiWebConnectResponse, GetApiWebSessionByIdData, PostApiWebIntegrationConnectionData, PostApiWebIntegrationConnectionResponse } from '../types.gen';
...
export const postApiNativeChatCompletionsQueryKey = (options: Options<PostApiNativeChatCompletionsData>) => createQueryKey('postApiNativeChatCompletions', options);

export const postApiNativeChatCompletionsOptions = (options: Options<PostApiNativeChatCompletionsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
        ...
        queryKey: postApiNativeChatCompletionsQueryKey(options)
    });
};

export const postApiNativeChatCompletionsMutation = (options?: Partial<Options<PostApiNativeChatCompletionsData>>) => {
    const mutationOptions: UseMutationOptions<unknown, DefaultError, Options<PostApiNativeChatCompletionsData>> = {
