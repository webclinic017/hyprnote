...
import type { GetHealthData, GetApiNativeUserIntegrationsData, GetApiNativeUserIntegrationsResponse, GetApiNativeSubscriptionData, GetApiNativeSubscriptionResponse, PostApiNativeCreateTitleData, PostApiNativeCreateTitleResponse, PostApiNativeLiveSummaryData, PostApiNativeLiveSummaryResponse, PostApiNativePostprocessEnhanceData, PostApiNativePostprocessEnhanceResponse, PostApiWebConnectData, PostApiWebConnectResponse, GetApiWebSessionByIdData, GetApiWebSessionByIdResponse, PostApiWebIntegrationConnectionData, PostApiWebIntegrationConnectionResponse } from './types.gen';
...
export const postApiNativeLiveSummary = <ThrowOnError extends boolean = false>(options: Options<PostApiNativeLiveSummaryData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiNativeLiveSummaryResponse, unknown, ThrowOnError>({
