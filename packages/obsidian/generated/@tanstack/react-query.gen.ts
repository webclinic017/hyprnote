...
export const postActiveQueryKey = (options: Options<PostActiveData>) => createQueryKey('postActive', options);
...
export const postCommandsByCommandIdQueryKey = (options: Options<PostCommandsByCommandIdData>) => createQueryKey('postCommandsByCommandId', options);
...
export const getObsidianLocalRestApiCrtOptions = (options?: Options<GetObsidianLocalRestApiCrtData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
...
export const postOpenByFilenameQueryKey = (options: Options<PostOpenByFilenameData>) => createQueryKey('postOpenByFilename', options);
...
export const postPeriodicByPeriodQueryKey = (options: Options<PostPeriodicByPeriodData>) => createQueryKey('postPeriodicByPeriod', options);
...
export const deletePeriodicByPeriodByYearByMonthByDayMutation = (options?: Partial<Options<DeletePeriodicByPeriodByYearByMonthByDayData>>) => {
...
export const getPeriodicByPeriodByYearByMonthByDayOptions = (options: Options<GetPeriodicByPeriodByYearByMonthByDayData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
...
export const patchPeriodicByPeriodByYearByMonthByDayMutation = (options?: Partial<Options<PatchPeriodicByPeriodByYearByMonthByDayData>>) => {
...
export const postPeriodicByPeriodByYearByMonthByDayQueryKey = (options: Options<PostPeriodicByPeriodByYearByMonthByDayData>) => createQueryKey('postPeriodicByPeriodByYearByMonthByDay', options);

export const postPeriodicByPeriodByYearByMonthByDayOptions = (options: Options<PostPeriodicByPeriodByYearByMonthByDayData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
...
export const postPeriodicByPeriodByYearByMonthByDayMutation = (options?: Partial<Options<PostPeriodicByPeriodByYearByMonthByDayData>>) => {
...
export const putPeriodicByPeriodByYearByMonthByDayMutation = (options?: Partial<Options<PutPeriodicByPeriodByYearByMonthByDayData>>) => {
...
export const postSearchQueryKey = (options: Options<PostSearchData>) => createQueryKey('postSearch', options);
...
export const postSearchSimpleQueryKey = (options: Options<PostSearchSimpleData>) => createQueryKey('postSearchSimple', options);
...
export const postVaultByFilenameQueryKey = (options: Options<PostVaultByFilenameData>) => createQueryKey('postVaultByFilename', options);
