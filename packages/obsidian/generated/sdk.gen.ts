 ...
 *
 */
export const getObsidianLocalRestApiCrt = <ThrowOnError extends boolean = false>(options?: Options<GetObsidianLocalRestApiCrtData, ThrowOnError>) => {
 ...
 *
 */
export const getOpenapiYaml = <ThrowOnError extends boolean = false>(options?: Options<GetOpenapiYamlData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<unknown, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
 ...
 *
 */
export const deletePeriodicByPeriodByYearByMonthByDay = <ThrowOnError extends boolean = false>(options: Options<DeletePeriodicByPeriodByYearByMonthByDayData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeletePeriodicByPeriodByYearByMonthByDayResponse, DeletePeriodicByPeriodByYearByMonthByDayError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 *
 */
export const getPeriodicByPeriodByYearByMonthByDay = <ThrowOnError extends boolean = false>(options: Options<GetPeriodicByPeriodByYearByMonthByDayData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetPeriodicByPeriodByYearByMonthByDayResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 *
 */
export const patchPeriodicByPeriodByYearByMonthByDay = <ThrowOnError extends boolean = false>(options: Options<PatchPeriodicByPeriodByYearByMonthByDayData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<unknown, PatchPeriodicByPeriodByYearByMonthByDayError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 *
 */
export const postPeriodicByPeriodByYearByMonthByDay = <ThrowOnError extends boolean = false>(options: Options<PostPeriodicByPeriodByYearByMonthByDayData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostPeriodicByPeriodByYearByMonthByDayResponse, PostPeriodicByPeriodByYearByMonthByDayError, ThrowOnError>({
        bodySerializer: null,
        security: [
            {
                scheme: 'bearer',
 ...
 *
 */
export const putPeriodicByPeriodByYearByMonthByDay = <ThrowOnError extends boolean = false>(options: Options<PutPeriodicByPeriodByYearByMonthByDayData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<PutPeriodicByPeriodByYearByMonthByDayResponse, PutPeriodicByPeriodByYearByMonthByDayError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
